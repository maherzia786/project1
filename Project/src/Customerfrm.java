...
public class Customerfrm extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Customerfrm frame = new Customerfrm("maher");
	 ...
	 * Create the frame.
	 */
	public Customerfrm(String name) {
		setTitle("Customer");
		...
		Object[] coloumns = {"Sl", "Customer Name", "Total Sales", "Total Payment", "Balance"};
		...
		JButton btnPurchase_3 = new JButton("Add Customer");
