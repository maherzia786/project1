...
public class ProductFRM extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ProductFRM frame = new ProductFRM("maher");
	...
	public ProductFRM(String name) {
		...
		JButton btnNewButton_1_3 = new JButton("Supplier");
		...
		JLabel lblNewLabel_2_2 = new JLabel("Inventory");
		...
		Object[] coloumns = {"Sl", "Product Name", "Total Purchase", "Total Sold", "Balance"};
		...
		try {
			...
			double ta = s.totalPro(a);
			double tp = p.totalPro(a);
		...
		JButton btnPurchase_3 = new JButton("Add Inventory");
		...
		JLabel lblNewLabel_1 = new JLabel("Inventory Details !!");
