...
public class PurchaseFrm extends JFrame {

	private JPanel contentPane;
	private JTextField dateField;
	private JTextField rateField_1;
	private JTextField quantiyField_2;
	private JTextField supplierField_3;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PurchaseFrm frame = new PurchaseFrm("maher");
	 ...
	 * Create the frame.
	 */
	public PurchaseFrm(String name) {
		setTitle("Purchase");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(260, 150, 1142, 523);
		...
		lblNewLabel.setBounds(200, 10, 748, 54);
		...
		btnSale.setBounds(10, 45, 139, 40);
		btnSale.setForeground(Color.WHITE);
		btnSale.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 15));
		...
		btnNewButton_1_1.setBounds(10, 115, 139, 40);
		...
		btnNewButton_1_2.setBounds(10, 187, 139, 40);
		...
		btnNewButton_1_3.setBounds(10, 264, 139, 40);
		...
		separator.setBounds(0, 105, 159, 215);
		panel.add(separator);
		
		JSeparator separator_1 = new JSeparator();
		separator_1.setBounds(0, 177, 159, 143);
		panel.add(separator_1);
		
		JSeparator separator_2 = new JSeparator();
		separator_2.setBounds(0, 254, 159, 66);
		panel.add(separator_2);
		
		JSeparator separator_3 = new JSeparator();
		separator_3.setBounds(0, 320, 159, 0);
		...
		comboBox_1.setBounds(261, 165, 170, 24);
		...
		comboBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				supplierField_3.setText(comboBox.getSelectedItem().toString());
		...
		comboBox.setBounds(261, 111, 175, 24);
		
		panel_1.add(comboBox);
		
		JLabel lblNewLabel_1 = new JLabel("Please enter purchase!!!");
		...
		dateField.setBounds(69, 111, 121, 24);
		...
		lblNewLabel_2_1_1.setBounds(194, 165, 73, 24);
		...
		rateField_1.setBounds(69, 167, 121, 24);
		...
		quantiyField_2.setBounds(69, 223, 146, 24);
		...
		lblNewLabel_2_2.setBounds(194, 111, 73, 24);
		panel_1.add(lblNewLabel_2_2);
		
		supplierField_3 = new JTextField();
		supplierField_3.setEditable(false);
		supplierField_3.setFont(new Font("Arial Rounded MT Bold", Font.PLAIN, 13));
		supplierField_3.setColumns(10);
		supplierField_3.setBounds(261, 111, 175, 24);
		panel_1.add(supplierField_3);
		...
		productField_4.setBounds(261, 165, 170, 24);
		...
		lblNewLabel_2_3_1.setBounds(237, 223, 82, 24);
		...
		paymentField_5.setBounds(312, 221, 140, 24);
		...
		Object[] coloumns = {"Date", "Supplier", "Product", "Rate", "Quantity", "Amount", "Payment"};
		...
		JLabel lblNewLabel_1_1 = new JLabel("Purchase Details !!");
		...
		btnNewButton.setBounds(33, 326, 161, 40);
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				s.addPurchase(dateField.getText(), supplierField_3.getText(), productField_4.getText(), Double.parseDouble(quantiyField_2.getText()), Double.parseDouble(rateField_1.getText()) , Double.parseDouble(paymentField_5.getText()));
				boolean ab = s.savePurchase();
				
				if(ab) {
					JOptionPane.showMessageDialog(null, "Purchase added successfully");
					
					row[0]= dateField.getText();
					row[1]= supplierField_3.getText();
		...
		btnAdd.setBounds(270, 326, 161, 40);
		panel_1.add(btnAdd);
